...
public class Encodes {
	...
	public  static final String[] pros =  {"上海市","云南省","内蒙古","北京市","吉林省","四川省","天津市","宁夏","安徽省","山东省","山西省","广东省","广西","新疆","江苏省","江西省","河北省","河南省","浙江省","海南省","湖北省","湖南省","甘肃省","福建省","西藏","贵州省","辽宁省","重庆市","陕西省","青海省","黑龙江"};
	...
	public static  String createPassword(int length) {
		...
		builder.append(str.charAt((int) (Math.random() * 56)));
		}
	...
	*/
	...
	public static String cities(Integer pro) {
		try {
			return pros[pro-1];
		} catch (Exception e) {
			throw Exceptions.unchecked(e);
