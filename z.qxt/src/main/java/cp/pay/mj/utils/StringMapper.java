...
public class StringMapper {
	public static String DEFAULT_DATEMONTH_FORMAT = "yyyy-MM";
	public static String DEFAULT_DATE_FORMAT = "yyyy-MM-dd";
	public static String DEFAULT_DATETIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
	public static String DEFAULT_DATEHOUR_FORMAT = "yyyy-MM-dd HH";
	...
	static {
		...
		StringMapper.registerDateConverter(DEFAULT_DATE_FORMAT, DEFAULT_DATETIME_FORMAT,DEFAULT_DATEHOUR_FORMAT);
	}
