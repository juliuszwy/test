            ...
            Mapper mapper)
    {
        MapperWrapper resMapper = new MapperWrapper(mapper)
        {
            ...
            public Class realClass(String elementName)
            {
                ...
                {
                	logger.warn("xstream change xml to object. filed (0) not exsit. ", e);
//                    logger.warn("xstream change xml to object. filed (0) not exsit. ",elementName);
                }
                return res;
            }
        };
    ...
    */
            ...
            boolean isSkipOverElement)
    {
        ...
        {
            res = new XStream(new MyXppDriver(nameCoder))
            {
